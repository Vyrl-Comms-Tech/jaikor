...
const LargeSection = ({ lenis }) => {
  ...
  useEffect(() => {
    ...
    if (houseSvg) {
      ...
      gsap.to(svgPaths, {
        strokeDashoffset: 0,
        duration: 0.4, // Reduced duration for quicker stroke animation
        stagger: 0.1, // Increased stagger for noticeable delay between paths
        ease: "power4.inOut",
        scrollTrigger: {
          trigger: ".large-section-image",
          start: "top center",
          end: "bottom center",
      ...
      gsap.to(svgPaths, {
        fillOpacity: 1,
        duration: 0.5, // Reduced duration for quicker stroke animation
        stagger: 0.01, // Increased stagger for noticeable delay between paths
        ease: "power4.inOut",
        scrollTrigger: {
          trigger: ".large-section-image",
          start: "top center",
