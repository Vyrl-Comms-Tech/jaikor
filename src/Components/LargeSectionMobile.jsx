...
const LargeSectionMobile = () => {
  ...
  useGSAP(() => {
    ...
    // Animate house svg
    const houseSvg = containerRef.current.querySelector(".mobile-house-svg");
    if (houseSvg) {
      ...
      <div className="large-mobile-section" ref={containerRef}>
        ...
        <div className="mobile-large-svg">
          ...
          >
            ...
            <path
              ref={pathRef}
              d="M14 0L11.4662 438.423L9.33784 897.241L6.95217 1411.52L7 1509"
              fill="none"
              stroke="#F5F5F5"
              strokeWidth="1"
            />
