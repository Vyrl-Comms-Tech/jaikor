    ...
    <div className="mobile-navbar">
      ...
      <div className={`mobile-menu ${isOpen ? 'active' : ''}`} ref={menuRef}>
        ...
        <div className="mobile-menu-links">
          ...
          <NavLink to="/projects" className="mobile-menu-link" onClick={closeMenu}>
            Projects
          </NavLink>
          <NavLink to="/services" className="mobile-menu-link" onClick={closeMenu}>
            Services
          </NavLink>
          <NavLink to="/contact" className="mobile-menu-link contact-link" onClick={closeMenu}>
            Let's Connect
          </NavLink>
        </div>
        <div className="mobile-contact-info">
          ...
          <div className="contact-item">
            <a href="https://twitter.com/jeikorgroup" target="_blank" rel="noopener noreferrer">Twitter</a>
          </div>
          </ div>
          <div className="contact-text">
            Headquartered In Dubai, We Continue To Deliver Excellence With A Focus On Safety, Sustainability, And Client Satisfaction.
          </div>
        </div>
      </div>
    </div>
